...
public class AlarmReminderProvider extends ContentProvider {
    ...
    static {
        sUriMatcher.addURI(AlarmReminderContract.contentAuthority,AlarmReminderContract.PATH_VEHICLE,REMINDER);
        sUriMatcher.addURI(AlarmReminderContract.contentAuthority,AlarmReminderContract.PATH_VEHICLE+"/#",REMINDER_ID);
